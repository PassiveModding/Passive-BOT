...
namespace PassiveBOT.Configuration.Objects
{
    public class FortniteProfile
    {
        ...
        public class CurrP9
        {
            public TrnRating6 trnRating { get; set; }
            public Score6 score { get; set; }
            public Top17 top1 { get; set; }
            public Top36 top3 { get; set; }
            public Top56 top5 { get; set; }
            public Top66 top6 { get; set; }
            public Top106 top10 { get; set; }
            public Top126 top12 { get; set; }
            public Top256 top25 { get; set; }
            public Kd6 kd { get; set; }
            public Matches6 matches { get; set; }
            public Kills6 kills { get; set; }
            public Kpg6 kpg { get; set; }
            public ScorePerMatch6 scorePerMatch { get; set; }
        }
